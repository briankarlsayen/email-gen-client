...
const AdminDashboard = () => {
  return (
    <div>
      <div
        id="sidebar"
        className="h-screen w-20 menu bg-white text-white px-4 flex items-center nunito fixed shadow justify-center"
      >
        <ul className="list-reset ">
          <li className="my-2 md:my-0">
            <a
              href="#"
              className="flex align-middle text-gray-600 no-underline hover:text-indigo-400 gap-4 justify-between"
            >
              {/* <i className="fas fa-home fa-fw mr-3"></i> */}
              <FaHome size={25} />
              <span className="w-full inline-block md:pb-0 text-sm">Home</span>
            </a>
          </li>
          <li className="my-2 md:my-0 ">
            <a
              href="#"
              className="flex align-middle text-gray-600 no-underline hover:text-indigo-400"
            >
              <FaTasks size={25} />
          ...
          <li className="my-2 md:my-0">
            <a
              href="#"
              className=" align-middle text-gray-600 no-underline hover:text-indigo-400"
            >
              <FaWallet size={25} />
              <span className="w-full inline-block pb-1 md:pb-0 text-sm">
                Payments
      ...
      <div className="flex flex-row flex-wrap flex-1 flex-grow content-start pl-20">
        ...
        <div
          id="dash-content"
          className="bg-gray-200 py-6 lg:py-0 w-full lg:max-w-sm flex flex-wrap content-start min-h-screen"
        >
